...
const HistoryPage: React.FC = () => {
  ...
  const categoryBreakdownList = Object.values(categoryData).sort(
    (a, b) => b.amount - a.amount,
  );
  const total = categoryBreakdownList.reduce((sum, cat) => sum + cat.amount, 0);
  const totalCount = categoryBreakdownList.reduce((sum, cat) => sum + cat.count, 0);
